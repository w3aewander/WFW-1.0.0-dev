                ...
                <aside class="sidebar">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-group inline">
                                ...
                                <li class="list-group-item inline">
                                    <span class="btn glyphicon glyphicon-book"></span><a href="/categorias">Categorias</a>
                                </li>
                                <li class="list-group-item inline">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-group inline">
                                <li class="list-group-item">
                                    <span class="btn glyphicon glyphicon-home"></span><a href="/admin">Área Administrativa</a>
                                </li>               
                            </ul>
                        </div>
                    </div>                    
